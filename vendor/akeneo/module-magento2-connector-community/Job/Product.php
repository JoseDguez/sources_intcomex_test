    ...
    public function insertData()
    {
        ...
        foreach ($filters as $filter) {
            ...
            foreach ($products as $product) {
                ...
                if($product['family'] == 'Kit' || strpos($product['family'], 'Kit') === true ){
                    var_dump($product);
                }else{
                    var_dump('este producto no es de kit');
                }
                /**
                        ...
                        if (isset($option['label']) && isset($optionApiAttribute['labels']) && isset($optionApiAttribute['code'])) {
                            if (in_array($option['label'], $optionApiAttribute['labels'])) {
                                ...
                                foreach ($websites as $websiteCode => $affected) {
                                    $this->setAdditionalMessage('Codigo que llega: '.$websiteCode.'',$this->logger);
                                    $this->setAdditionalMessage('Codigo que compara: '.$optionApiAttribute['code'].'',$this->logger);
                                    switch ($websiteCode){
                                        case 'cl':
                                            $websiteCode = 'xcl';
                                            break;
                                    ...
                                    $this->setAdditionalMessage('Codigo que se ajusta: '.$websiteCode.'',$this->logger);
